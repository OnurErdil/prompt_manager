...
- [ ] M1.10 kapsamında temel tema, spacing, typography, button/input/appbar standardı uygulanmıştır.
- [ ] Auth ve placeholder ekranları minimum ürün hissi verirken AuthController bağlantısı ve validation davranışı korunur.
- [ ] M1.10 kapsamında logo, app icon, onboarding, animasyon, premium polish, tam marka sistemi, tüm ekranların final tasarımı, PromptCard/Firestore/prompt ekleme özellikleri eklenmez.
...
| M1 | AuthGate, login, register, logout çalışıyor; temel tema ve UI standardı uygulanmış. |
